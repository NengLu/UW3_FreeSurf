...
outputPath = "op_2DRelaxation_FreeSurf_FSSA1" + "_yres{:n}_dt{:.2f}ka_Tmax{:.1f}ka/".format(yres,dim(dt_set,u.kiloyear).m,dim(max_time,u.kiloyear).m)
if uw.mpi.rank == 0:
...
if use_fssa:
    theta = 1.0*densityM*ND_gravity*dt_set
