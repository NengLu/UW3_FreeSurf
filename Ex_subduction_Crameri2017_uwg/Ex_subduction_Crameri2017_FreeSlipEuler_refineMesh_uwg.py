...
Model.outputDir= "output_fslipEuler_yres{}_uwg_refine".format(yRes)
...
#     Fig.Points(Model.swarm, Model.materialField,fn_size=2.0,discrete=True,colourBar=False,colours='white orange red')
#     Fig.show()
...
#radiogenicHeatProd = internalHeatingRate*refDensity*(3.0/3.3) 
...
# Crust.density =  GEO.LinearDensity(3300. * u.kilogram / u.metre**3,thermalExpansivity = r_tE,
...
geotherm_fn = fn.branching.conditional([(depthFn <= -platethickness ,Temp_mantle),
                                       (True,       halfSpaceTemp)])
...
# Model.set_temperatureBCs(top=300 * u.degK,
#                          bottom = 1900 * u.degK,
#                          materials=[(air, 300 * u.degK)])
Model.set_heatFlowBCs(bottom=(0. * u.milliwatt / u.metre**2,Mantle))
