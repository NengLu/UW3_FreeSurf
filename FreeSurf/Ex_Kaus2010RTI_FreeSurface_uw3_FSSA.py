...
#max_time  = ndim(5.0e4*u.year)
dt_set    = ndim(50.0e3*u.year)
...
outputPath = "op_uw3_Ex_Kaus2010RTI_FreeSurface_FSSA" + "_yres{:n}_dt{:.1f}ka_Tmax{:.1f}Ma/".format(yres,dim(dt_set,u.kiloyear).m,dim(max_time,u.megayear).m)
if uw.mpi.rank == 0:
...
theta = 0.5*densityD*ND_gravity*dt_set
